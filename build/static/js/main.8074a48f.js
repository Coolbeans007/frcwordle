/*! For license information please see main.8074a48f.js.LICENSE.txt */
!(function () {
  var e = {
      694: function (e, t) {
        var n;
      ...
      463: function (e, t, n) {
        ...
        function Ka() {
          if (!Ha && null !== Ia) {
            ...
            try {
              ...
              throw (null !== Ia && (Ia = Ia.slice(e + 1)), Ta(La, Ga), n);
            } finally {
              Ha = !1;
            }
          }
        ...
        function Mo(e, t) {
          switch ((fa(Lo, t), fa(jo, e), fa(Po, No), (e = t.nodeType))) {
            case 9:
            case 11:
        ...
        function li(e, t, n, r, a, o) {
          if (
            ...
            (t.updateQueue = null),
            (t.lanes = 0),
            (Xo.current = null === e || null === e.memoizedState ? Ri : Mi),
            (e = n(r, a)),
            ai)
          ) {
            o = 0;
        ...
        function mu(e, t, n) {
          ...
          Bt(e, t, n), e === Rl && ((Vl |= t), 4 === zl && bu(e, Dl));
          var r = Wa();
          1 === t
            ? 0 !== (8 & Ll) && 0 === (48 & Ll)
              ? yu(e)
        ...
        function vu(e, t) {
          ...
          if (((r = zt(e, e === Rl ? Dl : 0)), (t = At), 0 === r))
            ...
            15 === t
              ? ((n = yu.bind(null, e)),
                null === Ia ? ((Ia = [n]), (Ua = Ta(La, Ka))) : Ia.push(n),
                (n = Fa))
              : 14 === t
        ...
        function gu(e) {
          ...
          var n = zt(e, e === Rl ? Dl : 0);
          if (0 === n) return null;
          var r = n,
            a = Ll;
          Ll |= 16;
          var o = Tu();
          for ((Rl === e && Dl === r) || (Ql(), Eu(e, r)); ; )
            try {
              Nu();
              break;
            } catch (u) {
        ...
        function _u(e, t) {
          ...
          if ((no(), (Ll = n), (Pl.current = r), null !== Ml))
            throw Error(i(261));
          return (Rl = null), (Dl = 0), zl;
        }
        function Ou() {
          for (; null !== Ml; ) Pu(Ml);
        }
        ...
        var us = { Events: [ra, aa, oa, je, Le, Du, { current: !1 }] },
          ss = {
              ...
              i > l
                ? ((e.sortIndex = i),
                  ...
                  null === S(T) &&
                    e === S(_) &&
                    (R ? a() : (R = !0), r(D, i - l)))
                : ((e.sortIndex = u), x(T, e), L || j || ((L = !0), n(A))),
              e
            );
          }),
  ...
  (n.m = e),
    ...
    (function () {
      ...
      var d,
        ...
        M = "gameStats",
        D = function () {
          return "1" === localStorage.getItem(L);
        },
        A = n(184),
        F = function (e) {
          var t = e.value,
      ...
      function K(e) {
        ...
        var u = null != a ? a : d.None;
        if (u & d.Static) {
          var s = t.static,
            c = void 0 !== s && s,
            f = $(t, ["static"]);
          if (c) return Y(f, n, r, l);
        }
        if (u & d.RenderStrategy) {
          var m,
            h = t.unmount,
            v = void 0 === h || h,
            g = $(t, ["unmount"]);
          return G(
            v ? p.Unmount : p.Hidden,
            (((m = {})[p.Unmount] = function () {
              return null;
            }),
            (m[p.Hidden] = function () {
              return Y(
      ...
      function Te(t) {
        var n,
          ...
          b = g[0],
          y = g[1],
          w = h.unmount ? p.Unmount : p.Hidden,
          k = (function () {
      ...
      function ze(e, t) {
        var n = Array.isArray(e)
          ...
          a = (function () {
            if (t & (je.First | je.Next)) return Re.Next;
            if (t & (je.Previous | je.Last)) return Re.Previous;
            throw new Error(
        ...
        do {
          var c;
          if (l >= u || l + u <= 0) return Le.Error;
          var f = o + l;
          if (t & je.WrapAround) f = (f + u) % u;
          else {
            if (f < 0) return Le.Underflow;
            if (f >= u) return Le.Overflow;
          }
        ...
        (0, e.useEffect)(
            ...
            function () {
              if (f && t.current) {
                ...
                (null == o ? void 0 : o.current)
                  ? Fe(o.current)
                  : ze(t.current, je.First) === Le.Error &&
                    console.warn(
          ...
          Pe("keydown", function (e) {
            n & De.TabLock &&
              ...
              ) === Le.Success && (u.current = document.activeElement));
          }),
          Pe(
            "focus",
            function (e) {
      ...
      var st = d.RenderStrategy | d.Static,
        ct = X(function (t, n) {
          var r,
            a = t.open,
            o = t.onClose,
      ...
      var Lt = jt,
        ...
        Mt = function (e) {
          ...
          return (0, A.jsxs)("div", {
            ...
            children: [
              (0, A.jsx)(Rt, { label: "Total tries", value: t.totalGames }),
              (0, A.jsx)(Rt, {
                label: "Success rate",
              ...
              (0, A.jsx)(Rt, { label: "Best streak", value: t.bestStreak }),
            ],
          });
        },
        Dt = function (e) {
                ...
                (0, A.jsxs)("div", {
                  ...
                  children: [
                    ...
                    (0, A.jsx)(B, {
                      ...
                      onDelete: function () {
                        d(new (w())().splitGraphemes(c).slice(0, -1).join(""));
                      },
                      onEnter: function () {
                        if (!m && !V) {
                          if (S(c) !== _.length)
                          ...
                          if (((e = c), !s.includes(E(e)) && !f.includes(E(e))))
                            return (
      ...
      t.render(
        (0, A.jsx)(e.StrictMode, {
          children: (0, A.jsx)(Yt, { children: (0, A.jsx)(on, {}) }),
        }),
...
//# sourceMappingURL=main.8074a48f.js.map
